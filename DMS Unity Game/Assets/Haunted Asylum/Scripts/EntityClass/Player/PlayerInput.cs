...
public class PlayerInput
{
    ...
    //X is for head rotation, Y is for full body rotation
    public Vector3 GetNewRot()
    {
    ...
    public void Update(Stamina playerstam, PlayerState currentstate, GameObject Handlocation)
    {
        ...
        NewRot = Quaternion.Euler(new Vector3(RawRotation.x, RawRotation.y, 0));
